        ...
        <div className="h-screen">
            <div style={{ height: '70vh' }} >
                <Swiper autoplay={{
                    ...
                    <SwiperSlide><img src={landImage1} alt="랜딩이미지1" className="flex justify-center items-center" /></SwiperSlide>
                    <SwiperSlide><img src={landImage2} alt="랜딩이미지2" className="flex justify-center items-center" /></SwiperSlide>
                    <SwiperSlide><img src={landImage3} alt="랜딩이미지3" className="flex justify-center items-center" /></SwiperSlide>
                </Swiper>
            </div>
