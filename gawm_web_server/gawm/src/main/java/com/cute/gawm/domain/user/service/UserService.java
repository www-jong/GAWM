...
public class UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private String generateRandomNickname() {
        ...
        while (true) {
            ...
            if (userRepository.findByNickname(nickname) == null && bytes.length <= maxByteLength) {
                return nickname;
            }
        }
    }
